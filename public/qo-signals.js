...
(function () {
  ...
  function injectCSS() {
    ...
    var css =
      ...
      '.qs-chart{width:100%;height:234px;border-radius:10px;overflow:hidden;border:1px solid ' + c.bd + ';background:' + c.panel3 + ';margin-bottom:12px;box-shadow:0 1px 12px rgba(0,0,0,.22)}' +
