  ...
  window.mkPostCard = function (p) {
    ...
    return '<article class="mkx-post" style="border:1px solid ' + t.bd + ";border-radius:20px;background:" + t.cd + ';overflow:hidden;margin-bottom:16px">' +
      ...
      '<div style="display:flex;align-items:center;gap:20px;padding:13px 15px 4px">' +
        ...
        '<button class="mk-share mkx-act" data-pid="' + p.id + '" aria-label="Share" style="display:flex;align-items:center;gap:7px;background:none;border:none;cursor:pointer;color:' + t.t2 + ';font-family:inherit;font-size:14px;font-weight:700;padding:0">' + ic('<circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/>', 20) + "</button>" +
